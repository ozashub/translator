...
IMPROVE_SYSTEM = (
    ...
    "- NO BANNED AI WORDS: additionally, furthermore, moreover, pivotal, vital, "
    "delve, landscape (abstract), tapestry, testament, underscore (verb), "
    "showcase, foster, garner, intricate, interplay, enhance, align with, "
    "leverage, streamline, seamless, robust, comprehensive, innovative, "
    "groundbreaking, transformative, harness, empower, facilitate.\n"
